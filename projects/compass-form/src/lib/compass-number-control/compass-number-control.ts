  ...
  constructor(public config: CompassNumberControlConfig<ModelType>) {
    ...
    this.addValidator(field => {
      ...
      if (num !== parseFloat(value)) {
        return { numberMustBeInteger: "Value must be an integer" };
      }
