...
interface CompassRadioGroupControlConfig<ModelType, T>
...
export class CompassRadioGroupControl<ModelType, T> extends CompassControl<
  ModelType,
  T
> {
  ...
  update(model: ModelType) {
    ...
    s.verticalDisplay =
      c.verticalDisplay instanceof Function
        ? c.verticalDisplay(model)
        : c.verticalDisplay;
